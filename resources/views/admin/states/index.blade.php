<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2x1 font-semibold p-4">States Index</h1>
        <div class="p-4">
    ...
    <x-splade-table :for="$states">
        @cell('action', $state)
            <Link href="{{ route('admin.states.edit', $state) }}" class="px-3 py-2 bg-green-400 hover:bg-green-600 rounded m-2 text-white">
            ...
            <Link href="{{ route('admin.states.destroy', $state) }}" method="DELETE"
