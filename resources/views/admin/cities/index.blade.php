<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2x1 font-semibold p-4">Cities Index</h1>
        <div class="p-4">
    ...
    <x-splade-table :for="$cities">
        @cell('action', $city)
            <Link href="{{ route('admin.cities.edit', $city) }}" class="px-3 py-2 bg-green-400 hover:bg-green-600 rounded m-2 text-white">
