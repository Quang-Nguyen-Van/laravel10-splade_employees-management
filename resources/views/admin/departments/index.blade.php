<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2x1 font-semibold p-4">Departments Index</h1>
        <div class="p-4">
    ...
    <x-splade-table :for="$departments">
        @cell('action', $department)
            <Link href="{{ route('admin.departments.edit', $department) }}" class="px-3 py-2 bg-green-400 hover:bg-green-600 rounded m-2 text-white">
            ...
            <Link href="{{ route('admin.departments.destroy', $department) }}" method="DELETE"
                confirm-danger="Delete the department: {{ $department->name }}"
