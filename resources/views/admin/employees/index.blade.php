<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2x1 font-semibold p-4">Employees Index</h1>
        <div class="p-4">
    ...
    <x-splade-table :for="$employees">
        @cell('action', $employee)
            <Link href="{{ route('admin.employees.edit', $employee) }}" class="px-3 py-2 bg-green-400 hover:bg-green-600 rounded m-2 text-white">
            ...
            <Link href="{{ route('admin.employees.destroy', $employee) }}" method="DELETE"
                confirm-danger="Delete the employee: {{ $employee->name }}"
